"""
Django settings for test_lab_site project.
...
SECRET_KEY = '-8fg=d2#yspo)pstpn*mc6*!-78fhow(-l@jl*i*jb39sfhovc'
...
ROOT_URLCONF = 'test_lab_site.urls'
...
WSGI_APPLICATION = 'test_lab_site.wsgi.application'
